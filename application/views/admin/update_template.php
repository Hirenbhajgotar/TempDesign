    ...
    <div class="content-padder content-background">
        <div class="uk-section uk-section-small uk-section-default header">
            <div class="uk-container">
                <h2 class="ad_heading"><i class="far fa-edit"></i> Edit Template</h2>
                ...
                <ul class="uk-breadcrumb">
                    ...
                    <!-- <li><a href="<?= base_url('') ?>">Edit Template</a></li> -->
                </ul>
            </div>
        </div>
        <div class="uk-section-small">
            <div class="uk-container uk-container-large">
                <div uk-grid class="uk-child-width-1-1@s uk-child-width-1-1@m uk-child-width-1-1@l">
                    <div>
                        <form class="uk-grid-small" uk-grid action="<?= base_url("Template/edit_template_data/{$temp_data->id}") ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="uk-width-1-2@s">
                                ...
                                <div uk-form-custom="target: true">
                                    ...
                                    <?php
                                        if(isset($edit_image_error)){
                                            echo $edit_image_error;
                                        }
                                    ?>
                                </div>
                            ...
                            <div class="uk-width-1-2@s">
                                <input name="temp_header" class="uk-input" type="text" placeholder="Template Heading" value="<?= set_value('temp_header',$temp_data->temp_header) ?>">
                                <?= form_error('temp_header') ?>
                            </div>

                            <div class="uk-width-1-2@s">
                                <input name="temp_sub_header" class="uk-input" value="<?= set_value('temp_sub_header',$temp_data->temp_sub_header) ?>" type="text" placeholder="Sub Heading">
                                <?= form_error('temp_sub_header') ?>
                            </div>
                            
                            <div class="uk-width-1-2@s">
                                <input name="freamwork_name" class="uk-input" value="<?= set_value('freamwork_name',$temp_data->freamwork_name) ?>" type="text" placeholder="Freamwork Name">
                                <?= form_error('freamwork_name') ?>
                            </div>
                            <div class="uk-width-1-2@s">
                                <input name="freamwork_ver" class="uk-input" value="<?= set_value('freamwork_ver',$temp_data->freamwork_ver) ?>" type="text" placeholder="Freamwork Version">
                                <?= form_error('freamwork_ver') ?>
                            </div>
                            <div class="uk-width-1-1">
                                <textarea name="description" class="uk-textarea" rows="5" placeholder="Description"><?= set_value('description',$temp_data->description) ?></textarea>
